...
public class SodiumUpsideDownFluidRenderer {
    ...
    public boolean renderUpsideDown(BlockRenderView world, FluidState fluidState, BlockPos pos, BlockPos offset, ChunkModelBuilder buffers, FluidRenderHandler handler) {
        int posX = pos.getX();
        int posY = pos.getY();
        int posZ = pos.getZ();
        ...
        ColorSampler<FluidState> colorizer = fluidRenderer.callCreateColorProviderAdapter(handler);
